...
class FixedFeatureAcquisitionNetworkFunction(ThompsonSampleFunctionNetwork):
    ...
    def __init__(
        ...
        super(ThompsonSampleFunctionNetwork, self).__init__(model)
        
        self.posterior_transform = model.dag.objective_function
        
        self.acq_func = acq_function(model = model)
        self.d = d
    ...
    def forward(self, X: Tensor):
        ...
        return self.acq_func.forward(X = X_full)
